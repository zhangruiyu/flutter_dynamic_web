...
//  static final String BaseStaticUrl = "https://app.mustbe.xyz/";
  static final String BaseUrl =
      isOnline ? "https://api.mustbe.xyz/" : "https://app.dfq.mobi/api/";
  static final String BaseStaticUrl =
      isOnline ? "https://app.mustbe.xyz/" : "https://app.dfq.mobi/";
  ...
  static final String HomeDetail = "index/gethomepage"; //获取首页信息
  ...
  static final String GetAllBorrowing =
      "product/getallappproductmodel"; //获取全部借款
